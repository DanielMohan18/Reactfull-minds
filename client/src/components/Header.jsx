...
const Header = () => {
  ...
  return (
   <div className="border-b-2 flex flex-col justify-evenly px-3 py-2">
    <Navbar >
      ...
      <form>
        <input rightIcon={FaSearch} type="text" placeholder="search..." className="px-3 py-1 hidden md:inline rounded-xl border border-gray-500">
        </input>
      </form>
      ...
      <div className="flex flex-wrap gap-2 md:order-2">
        <Button className="w-12 h-10 flex justify-center items-center rounded-3xl " color="gray" pill>
         <FaMoon />
        </Button>
        <Link to='/signin' >
         <Button className="rounded-lg text-black hover:bg-gradient-to-r from-amber-300 via-orange-300 to-red-300 hover:text-white font-semibold px-5  text-xl whitespace-nowrap"  color="gray" >
           Sign in
         </Button>
        </Link>
