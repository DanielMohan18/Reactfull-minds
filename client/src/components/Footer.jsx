...
const Footere = () => {
  return (
    <Footer className='border border-t-8 border-orange-200  px-10 py-5'>
       <div className='w-full max-w-7xl mx-auto'>
          <div className='grid w-full justify-between sm:flex md:grid-cols-1 mb-2'>
            ...
            <div >
                ...
                <Footer.LinkGroup col>
                    <FooterLink href='https://github.com/DanielMohan18' target='_blank' rel='noopener noreferer'>
                        Github
                    </FooterLink>
                    <FooterLink href='https://www.linkedin.com/in/daniel-mohan-kavuri-59abb928a/' target='_blank' rel='noopener noreferer'>
                        LinkedIN
                    </FooterLink>
                </Footer.LinkGroup>  
            </div>
